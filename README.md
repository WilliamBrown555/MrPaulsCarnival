# The Carnival Bar Menu

This repo is a publish target. Netlify serves `Carnival Website/` with an empty build
...
```
cd ../menus
python build.py carnival      # or just `python build.py` for all of them
```
